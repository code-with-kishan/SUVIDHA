...
export default function RequestsManagementPage() {
  ...
  const closeItem = async (id) => {
    const ok = window.confirm('Close this service request and delete it permanently?');
    if (!ok) return;
  ...
  return (
    <Layout title="Requests Management">
      <div className="hero-strip mb-4 p-5">
        <h2 className="text-2xl font-bold">Requests Management</h2>
        <p className="mt-1 text-sm text-slate-100">Monitor and update service request lifecycle.</p>
      </div>
